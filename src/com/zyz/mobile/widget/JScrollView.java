 ...
 *
 * fastscroll
 * http://code.google.com/p/android-cookbook/source/browse/trunk/OilCan/src/com/android/contacts/FastScrollView.java?r=18
 */
public class JScrollView extends ScrollView{
	...
	@SuppressWarnings("unused")
	public JScrollView(Context context, AttributeSet attrs, int defStyle) {
